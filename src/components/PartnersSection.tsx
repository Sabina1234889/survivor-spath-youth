...
import { ChevronLeft, ChevronRight, Handshake, Building2 } from 'lucide-react';
import { PartnersCarouselSkeleton } from './common/SkeletonLoader';
...
export const PartnersSection: React.FC = () => {
  const { partners, isLoading } = useCms();
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-purple-50/70 rounded-3xl p-6 sm:p-10 lg:p-12 border border-purple-100/80 text-center space-y-8 shadow-xs relative overflow-hidden">
        ...
        {/* 3. SLIDER OR SKELETON LOADER */}
        {isLoading ? (
          <PartnersCarouselSkeleton />
        ) : displayPartners.length > 0 ? (
          <div className="space-y-6">
            {/* Slider Controls Bar & Status */}
            ...
            {/* Partners Carousel Slider Track */}
            <div
