...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  return (
    <div className="space-y-16 lg:space-y-24 pb-12 overflow-x-hidden">
      {/* ================= HERO SECTION ================= */}
      <section className="relative min-h-[580px] lg:min-h-[660px] flex items-center justify-center overflow-hidden bg-purple-950 text-white rounded-b-[2.5rem] lg:rounded-b-[3.5rem] shadow-xl hardware-accelerated">
        ...
        <div className="bg-gradient-to-br from-purple-50 via-white to-purple-50/50 rounded-3xl p-8 sm:p-12 lg:p-16 border border-purple-100 shadow-sm relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-2xl overflow-hidden shadow-lg border-4 border-white aspect-4/3 hardware-accelerated">
                <img
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 min-h-[500px]">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 border-b border-purple-100 pb-4">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-purple-950 font-display">
                Meet Our Heroes & Team
              </h2>
              <p className="text-gray-600 text-sm max-w-xl">
                Dedicated organizers, legal advisors, program leads, and youth ambassadors driving real community change.
              </p>
            </div>

            <button
              onClick={() => setActivePage('team')}
              className="px-5 py-2.5 rounded-xl font-bold text-xs uppercase tracking-wider text-purple-900 bg-purple-50 hover:bg-purple-100 border border-purple-200 shadow-xs flex items-center gap-1.5 transition-all cursor-pointer group shrink-0"
            >
